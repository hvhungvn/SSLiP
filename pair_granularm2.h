/* -*- c++ -*- ----------------------------------------------
   ...
   This file is modified by Viet Hung Ho (NTNU) to work with modified Mindlin model
------------------------------------------------------------------------- */

#ifdef PAIR_CLASS
// clang-format off
PairStyle(granular/m2,PairGranularM2);
// clang-format on
#else

#ifndef LMP_PAIR_GRANULARM2_H
#define LMP_PAIR_GRANULARM2_H

#include "pair.h"

namespace LAMMPS_NS {

class PairGranularM2 : public Pair {
 public:
  PairGranularM2(class LAMMPS *);
  ~PairGranularM2() override;
